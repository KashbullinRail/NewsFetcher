...
class FavouriteNewsSettincreenFragment : DialogFragment(R.layout.fragment_search_setting_screen),
    FragmentResultListener {

    private val binding by viewBinding(FragmentSearchSettingScreeninding::bind)
    ...
    private fun openDatePickerFrom() {
        childFragmentManager.setFragmentResultListener(
            REQUEST_DATE_FROM, viewLifecycleOwner, this@FavouriteNewsSettingScreenFragment
        )
        DateFromSetFragment
    ...
    private fun openDatePickerTo() {
        childFragmentManager.setFragmentResultListener(
            REQUEST_DATE_TO, viewLifecycleOwner, this@FavouriteNewsSettingScreenFragment
        )
        DateToSetFragment
